	...
	<div class="row">
		<div class="col-md-4">
			<div class="card mx-auto" >
			  <img src="./images/pinv3.png" style="width: 70%" class="card-img-top mx-auto" alt="card image cap">
			  <div class="card-body">
			    <h5 class="card-title">Profile Info</h5>
			    <p class="card-text"><i class=" fa fa-user">&nbsp; </i>Md: Abu Farhad</p>
			    <p class="card-text"><i class=" fa fa-user">&nbsp; </i>Admin</p>
			    <p class="card-text">Last Login time : xxxx-xx-xx</p>
			...
			<div class="jumbotron" style="width: 100%; height: 100%; ">
				...
				<div class="card">
			      <div class="card-body">
			        ...
			        <p class="card-text">Make invoices and create new order</p>
		...
		<div class="col-md-4">
			<div class="card">
		      <div class="card-body" >
		        ...
		        <p class="card-text">Manage Categories and add new parent and Categories </p>
